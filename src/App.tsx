          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-6">
              <button 
                onClick={loadData}
                disabled={refreshing}
                className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-600 rounded-xl text-[10px] sm:text-xs font-bold transition-all disabled:opacity-50"
              >
